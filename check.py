...
class MonthlyReportSystem:
    def __init__(self, root):
        ...
        # Employee details
        self.employee_details = pd.DataFrame(columns=["Month ", "Year", "Monitoring Group", "Database Group", "Area Team Details","Miscellaneous Groups","CPF Number", "Employee Name"])
    ...
    def show_main_frame(self):
        ...
        labels = ["Month ", "Year", "Monitoring Group", "Database Group", "Area Team Details","Miscellaneous Groups","CPF Number", "Employee Name"]
        ...
        for i, label in enumerate(labels):
            ...
            if label == "Month":
                entry = ttk.Combobox(self.manage_frame, values=month_values, state="readonly", width=27, font=("times new roman", 13, "bold"))
            elif label == "Year":
                entry = ttk.Combobox(self.manage_frame, values=year_values, state="readonly", width=27, font=("times new roman", 13, "bold"))
...
# Logo placement on the right side
        ...
        self.search_by['values'] = ("CPF Number", "Employee Name", "Department of Subsurface Team", "Month")
    ...
    def add_index_page(self, doc):
        ...
        index_data = [
          {"SI. No.": "1", "TITLE": f"Current Highlights {current_month_year}", "PageNo": "1"},
            {"SI. No.": "2",  "TITLE": "Month-wise Physical Targets and Performance","PageNo": "2"},
            {"SI. No.": "3", "TITLE": f"Work Over Operations {current_month_year}", "PageNo": "5"},
            {"SI. No.": "4", "TITLE": "Reservoir Field Operations", "PageNo": "6"},
            {"SI. No.": "5", "TITLE": "Pressure and Temperature Measurements", "PageNo": "6"},
            {"SI. No.": "6", "TITLE": "Well-wise Pressure & Temperature Data", "PageNo": "7"},
            {"SI. No.": "7", "TITLE": "Gas Production", "PageNo": "11"},
            {"SI. No.": "7.1", "TITLE": "Sand wise/ Well wise Gas Production", "PageNo": "13"},
            {"SI. No.": "8", "TITLE": f"Pay Zone Wise Status of Wells as on {current_month_year}", "PageNo": "18"},
            {"SI. No.": "9", "TITLE": "Production Test data", "PageNo": "20"},
            {"SI. No.": "9.1", "TITLE": "Latest Production Test Data of Flowing Wells", "PageNo": "25"},
            {"SI. No.": "10", "TITLE": "Pressure Production data (Initial testing) of unconnected wells", "PageNo": "27"},
            {"SI. No.": "11", "TITLE": "Development Locations available for drilling", "PageNo": "28"},
            {"SI. No.": "12", "TITLE": f"Status of Petroleum Mining Lease {current_month_year}", "PageNo": "29"}
        ]
